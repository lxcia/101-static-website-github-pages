...
location1 = "Santa Clara County, CA"
location2 = "San Joaquin County, CA"
location3 = "San Francisco County, CA"

# Define location endpoints
location1_end = 0.9365
location2_end = 1.5164
location3_end = 0.592
...
location1_morbidity = "2.1% 🟥 🟥 🟥"
location2_morbidity = "1.81% 🟥 🟥"
location3_morbidity = "1.38% 🟥 🟥"
...
def generateFrames(loop1, loop2, loop3):
    ...
    final_frame = go.Frame(
        data=[
            ...
            go.Scatter(x=xx3, y=yy3, mode="lines", line=dict(width=2, color="#c39999"), showlegend=False),
            # prev: x=[-0.22], y=[0.05]
            go.Scatter(x=[-0.49], y=[0.05], mode="text",
                       text="🤰 <b> Morbidity Rate: </b>" + location1_morbidity,
                       showlegend=False, textfont=dict(size=13, color="#c39999", family="Roboto, sans-serif"),
                       visible=True),
            go.Scatter(x=[-0.54], y=[0.55], mode="text",
                       text="🤰 <b> Morbidity Rate: </b>" + location2_morbidity,
                       showlegend=False, textfont=dict(size=13, color="#c39999", family="Roboto, sans-serif"),
                       visible=True),
            go.Scatter(x=[-0.53], y=[-0.45], mode="text",
...
fig = go.Figure(
        ...
        layout=go.Layout(
            ...
            title=dict(
                text="Clinic Access and Prenatal Care - California",
            ...
            updatemenus=[
                dict(
                    ...
                    x=0.46,  # Adjust the x-coordinate for the entire button group
