...
location1 = "Schuylkill County, PA"
location2 = "Northampton County, PA"
location3 = "Monroe County, PA"

# Define location endpoints
location1_end = 1.9365
location2_end = 0.41375
location3_end = 1.0565
...
location1_morbidity = "0.96% 🟥"
location2_morbidity = "8.49% 🟥 🟥 🟥 🟥 🟥"
location3_morbidity = "1.58% 🟥 🟥"
...
def generateFrames(loop1, loop2, loop3):
    ...
    final_frame = go.Frame(
        data=[
            ...
            go.Scatter(x=xx3, y=yy3, mode="lines", line=dict(width=2, color="#c39999"), showlegend=False),
            # prev: x=[-0.22], y=[0.05]
            go.Scatter(x=[-0.58], y=[0.05], mode="text",
                       text="🤰 <b> Morbidity Rate: </b>" + location1_morbidity,
                       showlegend=False, textfont=dict(size=13, color="#c39999", family="Roboto, sans-serif"),
                       visible=True),
            go.Scatter(x=[-0.39], y=[0.55], mode="text",
                       text="🤰 <b> Morbidity Rate: </b>" + location2_morbidity,
                       showlegend=False, textfont=dict(size=13, color="#c39999", family="Roboto, sans-serif"),
                       visible=True),
            go.Scatter(x=[-0.52], y=[-0.45], mode="text",
...
fig = go.Figure(
        ...
        layout=go.Layout(
            ...
            title=dict(
                text="Clinic Access and Prenatal Care - Pennsylvania",
            ...
            updatemenus=[
                dict(
                    ...
                    x=0.50,  # Adjust the x-coordinate for the entire button group
